...
// on Wednesday, May 20, 2015 at 4:54:23 PM.
// Edit at your own risk.
// ===========================================================================

package com.norswap.autumn.test.rats;
 ...
 */
public final class RatsJava7Parser extends ParserBase {
  ...
  static final class JavaSevenColumn extends Column {
    Chunk1 chunk1;
    Chunk2 chunk2;
    Chunk3 chunk3;
    Chunk4 chunk4;
   ...
   */
  public RatsJava7Parser(final Reader reader, final String file) {
    super(reader, file);
  }
   ...
   */
  public RatsJava7Parser(final Reader reader, final String file, final int size) {
   ...
   * @return The result.
   * @throws java.io.IOException Signals an I/O error.
   */
  ...
  private Result pModifiers(final int yyStart) throws IOException {
    JavaSevenColumn yyColumn = (JavaSevenColumn)column(yyStart);
